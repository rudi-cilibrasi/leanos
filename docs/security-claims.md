...
| SC-COMPOSITE-GATE-CONTRACT | `composite_gate_typed_result_contract` | `FailStop.gate_completed_sound`; `FailStop.gate_mode_rejection_atomicity` | Every operation of `FailStop.gate` | Completed result, or a busy/halted gate rejection | Proved | Operation-specific success predicates and nonfatal subsystem-rejection atomicity until their slices land; generated adapters, concurrency/SMP, compiler, QEMU, hardware |
