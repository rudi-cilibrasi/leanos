...
| SC-USER-RETURN-CONFINEMENT | `user_return_context_confinement` | `Interrupt.accepted_user_return_context_confined` | `Interrupt.validateUserReturn` | The total validator accepts the complete outgoing request | Proved | Frame/flag decoding, generated adapter, assembly, CR3/TLB writes, `iretq`, compiler, QEMU, hardware |
