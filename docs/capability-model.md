...
slots. Each occupied slot contains an object identifier and nonempty subset of
...
- `copy_preserves_wellFormed` and `revoke_preserves_wellFormed` prove both total
  operations preserve valid subjects, valid objects, and nonempty slot rights.
