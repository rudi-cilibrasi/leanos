...
<!-- invariants:totals theorems=2496 files=62 examples=872 -->
...
- `corpus_shape` — The frozen corpus contains exactly 380 test rows.
...
- `hosted_budget_vectors_exact` — The tail of the corpus, from row 356 onward, is exactly the frame-budget scenario's row list.
