...
<!-- invariants:totals theorems=2622 files=62 examples=872 -->
...
- `subject_termination_checked_retired_memory_candidate_exists` — Canonical checked subject termination now constructs a concrete receipt-consuming retired-memory successor, proves the exact object/frame release checks and finite IOMMU validation succeed, and publishes that successor with the complete outer invariant.
