...
<!-- invariants:totals theorems=2471 files=62 examples=872 -->
...
- `executable_subject_termination_cleanup_witness` — A concrete finite owner has a live device assignment, mapping, and matching cached frame-lifetime translation; the complete mapping-plus-assignment cleanup scope covers that key and makes it absent.
