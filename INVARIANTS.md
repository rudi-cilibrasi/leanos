...
<!-- invariants:totals theorems=2595 files=62 examples=872 -->
...
- `subject_termination_checked_authoritative_exact_completion_scrubs_fresh_frame` — Composing exact cleanup completion with an accepted real allocator transition preserves the authoritative invariant, binds the new object to the exact retired DMA frame, and proves the newly published lifetime is scrubbed.
