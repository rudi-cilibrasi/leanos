...
- `qotom_entry_checkpoint_withholds_cpl3_and_gates_result` — The Qotom entry checkpoint never grants general CPL3 authority, and its frame/register claim requires the complete accepted two-entry, one-return, root-closure result.
