...
<!-- invariants:totals theorems=2511 files=62 examples=872 -->
...
- `checked_control_unmap_authoritative_prepare_binds_exact_scope` — Every accepted checked unmap prepared through the single caller-visible front door binds its fresh ticket to the complete mapping-lifetime scope and retained old cache derived from the invariant-bearing authoritative pre-state; the concrete acceptance proof remains explicit rather than assumed by this conditional theorem.
