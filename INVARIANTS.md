...
- `subject_termination_checked_apply_stutters` — The current outer authoritative gate necessarily stutters on canonical subject termination because it retains the stale scrub-memory capability projection; publication requires explicit scrub reconciliation rather than another IOMMU validator lemma.
