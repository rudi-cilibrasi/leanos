...
python3 scripts/run-qotom-recovery-lab.py \
  ...
  --elf build/qotom-exception-integration-lab/leanos-qotom-lab.elf \
  --output build/qotom-exception-integration-lab/physical-exception-integration-rf-20260912 \
  --cycles 1 --scenario watchdog-leanos --pci-diagnostic \
  --diagnostic-protocol build/qotom-exception-integration-lab/boot/serial-protocol.tsv \
