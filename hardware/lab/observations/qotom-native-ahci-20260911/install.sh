...
stage=/var/tmp/leanos-ahci-stage-202f95f
mnt=/mnt/leanos-verify
test "$(sha256 -q "$stage/leanos-qotom-lab.elf")" = ed5959168554891957b49d7aae7a0618f39874ba40eb5810a98ddfd8ab3dbc90
test "$(sha256 -q "$stage/leanos.sha256")" = ff89954d5a9c798bfc1706cdb663a41b5565655193d244b4ca9fc58f59dcca3f
test "$(sha256 -q "$stage/grub.cfg")" = a45c7340ef76dc9db888d8bbe58b61144483231d12fcae29a25a9ac58f229972
test ! -e /var/tmp/leanos-before-ahci-202f95f.tar.gz
...
sudo -n tar -czf /var/tmp/leanos-before-ahci-202f95f.tar.gz -C "$mnt" boot
...
test "$(sha256 -q "$mnt/boot/leanos.sha256")" = ff89954d5a9c798bfc1706cdb663a41b5565655193d244b4ca9fc58f59dcca3f
