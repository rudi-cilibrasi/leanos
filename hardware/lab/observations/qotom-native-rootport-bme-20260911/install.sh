...
stage=/var/tmp/leanos-rootport-bme-stage-f31463d
mnt=/mnt/leanos-verify
test "$(sha256 -q "$stage/leanos-qotom-lab.elf")" = da6dff89a00f5e0d448761d1e0f9ac843b2ee66fab8d6ac28dd87d6d3d4b017a
test "$(sha256 -q "$stage/leanos.sha256")" = be40485e8f373c87f33ad798b0cc0ed1848d7fb781711ae1f114f6fe32f9c3f5
test "$(sha256 -q "$stage/grub.cfg")" = 31c32a61aacd4cf83460274e27e8042f9cc4e42fec9e21ce8abd0a7ca5feb5a0
test ! -e /var/tmp/leanos-before-rootport-bme-f31463d.tar.gz
...
sudo -n tar -czf /var/tmp/leanos-before-rootport-bme-f31463d.tar.gz -C "$mnt" boot
