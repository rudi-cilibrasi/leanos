...
python3 scripts/run-qotom-recovery-lab.py \
  ...
  --elf build/qotom-nosmap-control-lab/leanos-qotom-lab.elf \
  --output build/qotom-nosmap-control-lab/physical-native-nosmap-control-20260912 \
  --cycles 1 --scenario watchdog-leanos --pci-diagnostic \
  --diagnostic-protocol build/qotom-nosmap-control-lab/boot/serial-protocol.tsv \
