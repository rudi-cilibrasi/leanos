...
SSHPASS=freebsd python3 scripts/run-qotom-recovery-lab.py \
  ...
  --elf build/qotom-copy-root-publication-lab/leanos-qotom-lab.elf \
  --output build/qotom-copy-root-publication-lab/physical-native-copy-root-publication-20260912-retry1 \
  --cycles 1 --scenario watchdog-leanos --pci-diagnostic \
  --diagnostic-protocol build/qotom-copy-root-publication-lab/boot/serial-protocol.tsv \
