...
python3 scripts/run-qotom-recovery-lab.py \
  ...
  --elf build/qotom-bsp-lvt-policy-lab/leanos-qotom-lab.elf \
  --output /tmp/qotom-lvt-policy-20260912 \
  --cycles 1 --scenario watchdog-leanos --bsp-production --bsp-lvt-policy
