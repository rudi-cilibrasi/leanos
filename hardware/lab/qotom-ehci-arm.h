#ifndef LEANOS_LAB_QOTOM_EHCI_ARM_H
#define LEANOS_LAB_QOTOM_EHCI_ARM_H
...
static inline int lab_ehci_arm(struct lab_ehci_window *window,
     ...
     * every present alias to the EHCI page, regardless of leaf permissions. */
    for (unsigned i = 0; i < 4096; ++i)
        if ((view->pt[i] & 1) &&
            (view->pt[i] & UINT64_C(0x000ffffffffff000)) == QOTOM_EHCI_BAR) return 0;
