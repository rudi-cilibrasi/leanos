#ifndef LEANOS_LAB_QOTOM_AHCI_INTERRUPT_ARM_H
#define LEANOS_LAB_QOTOM_AHCI_INTERRUPT_ARM_H
...
static inline int lab_ahci_interrupt_arm(struct lab_ahci_interrupt_window *window,
    ...
    if(global_status!=QOTOM_AHCI_OK || port_status!=QOTOM_AHCI_PORT_OK ||
       ...
       !qotom_ahci_port_stopped(prior))return 0;
