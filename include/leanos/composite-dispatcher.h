 ...
 * 8..15 select one of 37 canonical states and all upper bits are reserved.
 * Command tags use bits 8..15 to select one of 39 commands and all upper
...
#define LEANOS_COMPOSITE_STATE_COUNT 37U
#define LEANOS_COMPOSITE_COMMAND_COUNT 39U
