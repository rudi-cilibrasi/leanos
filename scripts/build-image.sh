...
ld -m elf_x86_64 -nostdlib --gc-sections --build-id=none \
  ...
  "$build/Interrupt.o" "$build/BlockingIPC.o" "$build/CapabilityReuse.o"
ld -m elf_x86_64 -nostdlib --gc-sections --build-id=none \
  ...
  "$build/BootAllocation.o" "$build/Interrupt.o" "$build/BlockingIPC.o" "$build/CapabilityReuse.o"
ld -m elf_x86_64 -nostdlib --gc-sections --build-id=none \
...
ld -m elf_x86_64 -nostdlib --gc-sections --build-id=none \
  ...
  build/boot/BootAllocation.o build/boot/Interrupt.o build/boot/BlockingIPC.o build/boot/CapabilityReuse.o
ld -m elf_x86_64 -nostdlib --gc-sections --build-id=none \
