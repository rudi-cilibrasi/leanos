...
python3 scripts/test-qotom-pcie-pending-capture.py
...
"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-hda-bme.c -o "$build/hda-bme"
"$build/hda-bme"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
...
"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-realtek-state.c -o "$build/realtek-state"
"$build/realtek-state"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
...
"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-realtek-bme.c -o "$build/realtek-bme"
"$build/realtek-bme"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/qotom-realtek-bme.c -o "$build/realtek-bme-sanitized"
leanos_run_sanitized "$build/realtek-bme-sanitized"

"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-pcie-pending.c -o "$build/pcie-pending"
"$build/pcie-pending"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/qotom-pcie-pending.c -o "$build/pcie-pending-sanitized"
leanos_run_sanitized "$build/pcie-pending-sanitized"

"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/pci-power-observation.c -o "$build/pci-power"
"$build/pci-power"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/pci-power-observation.c -o "$build/pci-power-sanitized"
leanos_run_sanitized "$build/pci-power-sanitized"

"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-broadcom-d3.c -o "$build/broadcom-d3"
"$build/broadcom-d3"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/qotom-broadcom-d3.c -o "$build/broadcom-d3-sanitized"
leanos_run_sanitized "$build/broadcom-d3-sanitized"

"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-graphics-state.c -o "$build/graphics-state"
"$build/graphics-state"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/qotom-graphics-state.c -o "$build/graphics-state-sanitized"
leanos_run_sanitized "$build/graphics-state-sanitized"

"${CC:-gcc}" -std=c11 -O2 -Wall -Wextra -Werror tests/qotom-graphics-bme.c -o "$build/graphics-bme"
"$build/graphics-bme"
"$leanos_host_cc" -std=c11 "${leanos_host_sanitizer_flags[@]}" -Wall -Wextra -Werror \
  tests/qotom-graphics-bme.c -o "$build/graphics-bme-sanitized"
leanos_run_sanitized "$build/graphics-bme-sanitized"
