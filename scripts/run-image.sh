...
echo 'LEANOS/15 DMA snapshot=1 topology=000800020002 bus=0 scanned=256 present=5 optional-absent=1 writes=5 readbacks=5 bus-master=disabled stage=pre-cpl3 result=PASS' >> "$expected"
printf '%s\n' \
