...
echo 'LEANOS/15 DMA snapshot=1 topology=000800020002 bus=0 scanned=256 present=5 optional-absent=1 writes=5 readbacks=5 initial-bus-masters=1 initial-bus-master-mask=16 bus-master=disabled readback=exact global-state=257 generated-result=65793 stage=pre-cpl3 result=PASS' >> "$expected"
printf '%s\n' \
