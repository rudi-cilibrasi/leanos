...
assigned_current_signature="$(compute_check_signature assigned-edu \
  ...
  "$build/PrivilegeEntryControl.o" "$build/J1900CpuProfile.o" "$build/J1900MsrReadback.o" "$build/J1900CpuControlPolicy.o" "$build/BootTextConsole.o" "$build/PlatformAdmission.o" "$build/FaultDispatch.o")"
